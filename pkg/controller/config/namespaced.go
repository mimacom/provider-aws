...
func SetupNamespaced(mgr ctrl.Manager, o controller.Options) error {
	name := providerconfig.ControllerName(v1beta1m.ProviderConfigGroupKind)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1beta1m.ProviderConfig{}).
		Watches(&v1beta1m.ProviderConfigUsage{}, &resource.EnqueueRequestForProviderConfig{}).
